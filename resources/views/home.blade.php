        ...
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="https://stgecommerceprd.blob.core.windows.net/blob-ecom-img/assets/locacao_imoveis_0411d5d55c.jpg"
                    class="d-block mx-lg-auto img-fluid rounded-3 shadow-lg" alt="Rack com roupas estilosas penduradas"
            ...
            <div class="col-lg-6">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="{{ Auth::check() ? route('products.index') : route('login') }}"
                        class="btn bg-orange-500 text-white hover:bg-orange-600 btn-lg px-4 me-md-2 fw-bold">
                        Ver Imóveis </a>
                </div>
            </div>
        </div>
