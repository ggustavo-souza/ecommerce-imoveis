...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('products.index') }}" class="btn bg-orange-500 text-white hover:bg-orange-600">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('cart.update', $item->id) }}" method="POST" class="d-flex">
                                        ...
                                        <button type="submit" class=" outline-offset-2 rounded-xl hover:bg-orange-500 hover:text-white transition delay-50 duration-300 ms-2 p-1" title="Atualizar Quantidade"><i class="bi bi-arrow-repeat"></i></button>
                                    </form>
                                    {{-- Formulário Remover --}}
                ...
                <div class="card shadow-sm border-0 sticky-top" style="top: 2rem;">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mt-4">
                            <a href="{{ route('checkout.index') }}" class="btn bg-orange-500 text-white hover:bg-orange-600 btn-lg">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm text-center py-5">
                    <div class="card-body">
                        ...
                        <a href="{{ route('products.index') }}" class="btn bg-orange-500 text-white hover:bg-orange-600 mt-4">
